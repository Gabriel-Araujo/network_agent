...
### 4.1 Pipeline for create/edit configuration

If you identify the user wants to create a new configuration or edit one thats already exists you must follow this pipeline.
